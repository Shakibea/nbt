                      ...
                      : Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // List<String> matches = snap.forEach((element) {element.partyName;});
                              // matches
                              //     .map((e) => snap[index].partyName)
                              //     .toList();
                              // print(matches.length);
                              // for (String name in snapshots.data!.docs[index]
                              //     ['partyName']) {
                                  ...
                                  RawAutocomplete(
                                    optionsBuilder:
                                      ...
                                      if (textEditingValue.text == '') {
                                        ...
                                        //     .map((e) => e.partyName)
                                        //     .toList());
                                        // matches.add(snap[index].partyName);
                                        // matches.add(data.forEach((key, value) { matches.add(value);}));

                                        // for (String name in data['partyName']) {
                                        //   matches.add(name.toString());
                                        // }

                                        // for (var value in snapshots.data!.docs[index].values) {
                                        //   matches.add(value['partyName']);
                                        // }

                                        // for (int i = 0;
                                        //     i == snapshots.data!.docs.length;
                                        //     i++) {
                                        //   matches.add(snapshots.data!.docs[i]
                                        //       ['partyName']);
                                        // }

                                        // matches.add(snapshots.data!.docs[index]
                                        //     ['partyName']);
